 ...
 * iROWiki Renewal formula (same for ALL 6 stats):
 *   1–99:  floor((stat − 1) / 10) + 2
 *   100+:  4 × floor((stat − 100) / 5) + 16
 *
 * Verified in-game (bRO/LATAM screenshot):
 *   STR 120 → 32,  AGI 92 → 11,  VIT 110 → 24,
 *   INT 1 → 2,     DEX 35 → 5,   LUK 120 → 32  ✓
 */
